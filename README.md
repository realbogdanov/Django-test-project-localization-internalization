# Django-test-project-localization-internalization
Это тестовый проект который показывает мою работу с локализацией и интернацианлизацией в фреймворке Django
